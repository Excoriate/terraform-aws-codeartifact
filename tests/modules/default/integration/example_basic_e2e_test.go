...
// TestDeploymentOnExampleWhenBasicConfigurationApplied verifies that the basic example
// can be successfully deployed and creates the expected resources in AWS.
func TestDeploymentOnExampleWhenBasicConfigurationApplied(t *testing.T) {
	t.Parallel()
